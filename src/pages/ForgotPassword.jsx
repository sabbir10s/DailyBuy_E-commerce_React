...
const ForgotPassword = ({setPath}) => {
  ...
  return (
    <div>
      <div
        className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center h-[70vh] w-full">
            ...
            <div className="text-center pb-10">
              {newPassword
                ? (
                  <button
                    type="submit"
                    className="w-full text-xl lg:w-5/6 py-2.5 relative rounded group font-medium text-white inline-block">
                    <Link to="/signIn">
                      <span
