        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mt-8">
          <div className="lg:col-span-3  px-3 shadow-custom bg-[#F9FAFB] rounded-lg">
            ...
            {Array.from({ length: 2 }).map((_, idx) => (
              <div className="grid grid-cols-7 gap-4  bg-white p-3 mb-3 rounded items-center">
          ...
          <div className="relative">
            <div className="lg:absolute space-y-5 top-0 left-0 w-full h-auto  py-3 px-4 shadow-custom border rounded-lg">
