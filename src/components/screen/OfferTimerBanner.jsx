...
const OfferTimerBanner = () => {
    ...
    return (
        <div className="bg-primary-50 pt-6 md:pt-0 mt-8 lg:mt-16 relative">
            <img className="absolute z-0" src={bgImg} alt=""/>
            <div className="z-20">
                <div className="container">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        <div className="mx-auto lg:mx-0">
                            <h2
                                className="text-[#454F5B] text-center lg:text-left font-bold text-[32px] uppercase md:text-[40px] lg:text-[64px] md:leading-[45px] lg:leading-[80px]">
                                Get -60% from
                                <br/>
                                summer deal
                            </h2>
