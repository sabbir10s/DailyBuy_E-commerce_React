...
const WishlistCard = ({item}) => {
    ...
    return (
        <div >
                  <div className="max-w-[280px] md:max-w-full flex flex-col md:flex md:flex-row md:justify-between lg:grid lg:grid-cols-7 gap-2 lg:gap-4 md:mt-3 items-center border rounded-[10px] md:border-b md:border-gray-100 md:pb-2 relative md:static ">
                    ...
                    <p className="hidden md:block text-primary-600  font-semibold">${item?.price}.00</p>
