...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="hover:shadow-custom rounded-lg px-3 lg:py-6 py-3 w-full bg-white duration-300 transition ease-in border  overflow-hidden relative cursor-pointer border-gray-100/80">
      <div>
        <div
